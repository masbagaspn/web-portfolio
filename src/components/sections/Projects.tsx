...
const Projects = () => {
  ...
  return (
    <Section title="PROJECTS">
      <div
        ref={projectsRef}
        className="flex flex-col gap-10 sm:gap-16 xl:gap-20 2xl:gap-28"
      >
          ...
          <a href={project.href} target="_blank" key={idx}>
            <Card
              ...
              className={clsx(
                ...
                {
                  "rounded-md transition bg-lime-400/5 border-lime-400 shadow-sm":
                    currentHoverTarget === project.name,
                },
                {
